...
def if_not_matched(disease):
		...
		print("The common medications and procedures suggested by other real medical professionals are: \n")
		print(treatments+"\n")
...
class Greetings(KnowledgeEngine):
	...
	def _initial_action(self):
		print("")
		print("Hi! I am Dr. Experta, and will try to help make your health better")
